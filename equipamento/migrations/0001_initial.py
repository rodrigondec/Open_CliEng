    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ano_fabricacao', models.DateField(verbose_name='Ano fabricacao')),
                ...
                ('custo', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='BRL', max_digits=8)),
        ...
        migrations.CreateModel(
            name='Contrato',
            fields=[
                ('equipamento', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='contrato', serialize=False, to='equipamento.Equipamento')),
        ...
        migrations.AddField(
            ...
            name='setor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipamentos', to='local.Setor'),
        ),
    ]
